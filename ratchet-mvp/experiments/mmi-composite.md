...
with tiers. This probe (`probe_mmi.py`) implements the three dimensions as deterministically as possible
...
## Artefacts
- `probe_mmi.py` — MMI dimensions over `archmetrics`; current-state + `--hist` flask trajectory.
