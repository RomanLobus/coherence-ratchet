...
`probe_volatility_ratchet.py`, imports the shipped `coherence_ratchet` package (does not edit it);
...
> suppresses frozen/legacy-module false-positive backsliding flags (requests 8→5, httpie 5→4;
...
- `probe_volatility_ratchet.py` — standalone; imports (does not edit) `coherence_ratchet`; reuses
