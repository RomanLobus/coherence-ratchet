"""Customer charging — uses canonical helpers for money conversion and retry logic."""
from billing.money import to_cents
from billing.retry import retry


def charge_customer(order, gateway):
    """Convert order amount to cents and submit charge via gateway with automatic retries."""
