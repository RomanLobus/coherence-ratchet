...
## Rate, measured 12 August 2026

This record is an existence result at n=1 ensemble, and the rate was measured afterwards in
`entity-ensemble-distribution.md`: across forty ensembles over two model families, the mean was
2.75 distinct order shapes per five independent agents in one family and 1.60 in the other, and
**five distinct schemas from five agents did not occur once**. Divergence is real and this
record's headline is its tail. Cite this file for the mechanism and the KeyError-class breakage;
cite the distribution for any rate.
