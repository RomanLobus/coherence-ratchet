...
`@abstractmethod` detection) and D, then re-ran the longitudinal study (`scripts/longitudinal_arch.py`,
...
- `scripts/longitudinal_arch.py` — architecture-level history runner (cycle_ratio, coupling, I, A, D, pain).
- `data/longitudinal_arch_out.json` — last run's raw points.
