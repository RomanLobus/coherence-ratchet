...
**Probe (`scripts/probe_cochange.py`):** run the function-level duplication detector on three real libraries;
...
## Artefacts
- `scripts/probe_cochange.py` — reuses `coherence_ratchet.metrics` internals; per-cluster co-change over git history.
