...
one site changes. This probe (`scripts/probe_connascence.py`) (A) builds a connascence-of-meaning detector and
...
## Artefacts
- `scripts/probe_connascence.py` — connascence-of-meaning detector + locality×degree re-weighting; reuses
