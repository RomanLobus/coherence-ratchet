"""Fixtures reproducing the silent behaviour changes the experiments found — the cases a porous
characterisation suite waves through, and the proof harness must catch.
  ...
  - retry_faithful: a genuinely behaviour-preserving consolidation of retry_orig (should PROVE).
"""
